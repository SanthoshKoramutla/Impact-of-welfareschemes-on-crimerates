...
##############################
# Load crime data set
crime_df <- read.csv("/Users/santhoshkoramutla/Desktop/combined_crime_data.csv")

# Load expenditure data set
exp_df <- read.csv("/Users/santhoshkoramutla/Desktop/Expenditure_2010-2017_Final.csv")
...
stargazer(vio_m2, non_v_m2, type="text")
